...
function surligne(champ, erreur){
	if(erreur)
		jQuery(champ).css("border-color","#CA0036");
	else
		jQuery(champ).css("border-color","#A4A4A4");
}
...
$(document).on('click', '#valider_recherche', function(){
...
$(document).on('click', '#deposer_annonce', function(){
...
$(document).on('click', '#envoyer_message', function(){
...
$(document).on('click', '#connexion_button2', function(){
...
$(document).on('click', '#connexion_button', function(){
...
$(document).on('click', '#search_categorie', function(){
...
$(document).on('click', '#cat_annonce', function(){
