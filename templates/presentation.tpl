...
<div id="tabs"  style="margin-left:auto;margin-right:auto;min-height:100px ">
	...
	<div id="tabs-1" style="">
		<form method="get" name="rechercher" action="http://www.prixdupro.fr/index.php?page=search">
			<div class="blocInputRecherche" style="margin:0">
				<div style="float:left;margin: 3px;">Mots cl&eacute;s :</div>
			...
			<div class="blocInputRecherche">
				...
				<input id="search_categorie_hidden" type="hidden" value="{if isset($smarty.request.search_categorie)}{$smarty.request.search_categorie}{/if}"/>
				...
				<SELECT style="float:right;width:140px;" id="search_categorie" name="search_categorie" >
					...
					<optgroup label="Hi-Tech">
						...
						<OPTION id="osc11" VALUE="11">T&eacute;l&eacute;phonie</OPTION>
					</optgroup>
			...
			<div class="blocInputRecherche">
				...
				<input id="search_region_hidden" type="hidden" value="{if isset($smarty.request.search_region)}{$smarty.request.search_region}{/if}"/>
			...
			<div style="float:left">
				...
				<div id="carte-france">
					...
					<div class="clear"></div>
					<img src="/images/carte_regions.png" alt="carte r&eacute;gions" USEMAP="#m_carte_regions">
				...
				<SELECT style="float:right;width:140px;" id="search_region" name="search_region">
					...
					<OPTION id="osr10" VALUE="10">Franche-Comt&eacute;</OPTION>
					...
					<OPTION id="osr16" VALUE="16">Midi-Pyr&eacute;n&eacute;s</OPTION>
			...
			<div id="bloc_prix" class="blocInputRecherche" style="margin:0">
				<div style="">
					...
					<div style="float:right">
						<input id="search_prixmin_hidden" type="hidden" value="{if isset($smarty.request.search_prixmin)}{$smarty.request.search_prixmin}{/if}"/>
				...
				<div style="clear:both">
					...
					<div style="float:right;">
						<input id="search_prixmax_hidden" type="hidden" value="{if isset($smarty.request.search_prixmax)}{$smarty.request.search_prixmax}{/if}"/>
				...
				<div style="clear:both">
					<div style="float:left;margin-left: 3px;">Prix &agrave; debattre:</div>
					<input id="search_debat_annonce_hidden" type="hidden" value="{if isset($smarty.request.search_debat_annonce)}{$smarty.request.search_debat_annonce}{/if}"/>
			...
			<div id="bloc_annee" class="blocInputRecherche" style="display:none">
				<div style="">
					...
					<div style="float:right;">
						<input id="search_annee_min_hidden" type="hidden" value="{if isset($smarty.request.search_annee_min)}{$smarty.request.search_annee_min}{/if}"/>
				...
				<div style="clear:both">
					...
					<div style="float:right">
						<input id="search_annee_max_hidden" type="hidden" value="{if isset($smarty.request.search_annee_max)}{$smarty.request.search_annee_max}{/if}"/>
			...
			<div id="bloc_km" class="blocInputRecherche" style="display:none">
				<div style="">
					...
					<div style="float:right">
						<input id="search_km_min_hidden" type="hidden" value="{if isset($smarty.request.search_km_min)}{$smarty.request.search_km_min}{/if}"/>
				...
				<div style="clear:both">
					...
					<div style="float:right">
						<input id="search_km_max_hidden" type="hidden" value="{if isset($smarty.request.search_km_max)}{$smarty.request.search_km_max}{/if}"/>
			...
			<div id="bloc_energie_boite" class="blocInputRecherche" style="display:none">
				<div style="">
					...
					<div style="float:right">
						<input id="search_energie_hidden" type="hidden" value="{if isset($smarty.request.search_energie)}{$smarty.request.search_energie}{/if}"/>
				...
				<div style="clear:both">
					...
					<div style="float:right">
						<input id="search_boite_hidden" type="hidden" value="{if isset($smarty.request.search_boite)}{$smarty.request.search_boite}{/if}"/>
	...
	<div id="tabs-2" style="">
		...
		<form method="POST" name="depot_annonce" enctype="multipart/form-data" action="./index.php?page=depot_annonce">
			...
			<div id="bloc_photos" style="">
				...
				<div>
					...
					<input style="" type="checkbox" id="affiche_tel" name="affiche_tel" checked="checked" />
                                        <label for="affiche_tel" style="width:250px;">Afficher votre t&eacute;l&eacute;phone</label>
				</div>

				<div>
					<!--<div style="float:left">Prix &agrave; d&eacute;battre:</div>-->
					<input style="" type="checkbox" id="debat_annonce" name="debat_annonce"  />
                                        <label for="debat_annonce" style="width:250px;">Prix &agrave; d&eacute;battre</label>
				</div>
			...
			{elseif $smarty.session.etat == 'deconnecte'}
			<div style="float:left">
				<div style=" margin-bottom: 10px;">
					<span style="margin-bottom:10px;">Pour d&eacute;poser une annonce, il faut vous identifier.</span>
				</div>
	...
	<div id="tabs-3" style="">
		<form method="POST" name="creation_compte" action="./index.php?page=inscription">
			...
			<div style="float:left;margin-left:15px">
				...
				<div>
					...
					<SELECT style="float:left;width:140px;" id="region" name="region" onchange="getDepartements(this.value,'','bloc_depot_departements');">
						...
						<OPTION  VALUE="16">Midi-Pyr&eacute;n&eacute;s</OPTION>
			...
			<div id="indication_erreurs" style="float:left;margin-left:20px;color:#CA0036;width:255px;display:none">
				...
				<div>- les champs soient remplis</div>
				<div>- le numero de telephone poss&agrave;de 10 chiffres</div>
				<div>- l'adresse mail soit valide</div>
				<div>- le mot de passe poss&agrave;de au moins 6 caract&agrave;res</div>
			</div>
